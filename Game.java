                        ...
                        if (i == 0) {
                            ...
                            while (true) {
                                ...
                                if (money >= 50000) {
                                    ...
                                    System.out.println(" You can start the game from minimum 50000: Enter the required amount:  ");
                                    continue;
                                }
                            }
                    ...
                    for (int j = 1; j <= rounds; j++) //this loop handles the game rounds
                    {
                        for (int k = 0; k < players; k++) //this loops handles the players
                        {
                            if (j == 1) {
                                ...
                                if (cats == 0) {
                                    System.out.println(" Player " + (k + 1) + " has the Cats= 0");
                                } else {
                                    ...
                                    for (int i = 0; i < (gameplayers[k].total_cat); i++) {
                                        System.out.println(" Cat" + (i + 1) + " = ( 'Name='"
                                                ...
                                                + gameplayers[k].cats[i].get_price()+"SEK   Age= "
                                                + + gameplayers[k].cats[i].get_Age());
                                    }
                                }
                                if (dogs == 0) {
                                    System.out.println(" Player " + (k + 1) + " has the Dogs= 0");
                                } else {
                                    System.out.println(" Player " + (k + 1) + " has the Dogs ");
                                    for (int i = 0; i < gameplayers[k].total_dog; i++) {
                                        System.out.println(" Dog" + (i + 1) + " = ( 'Name='"
                                                ...
                                                + gameplayers[k].dogs[i].get_price()+"SEK  Age= "
                                                + gameplayers[k].dogs[i].get_Age()+"Months");
                                    }
                                }
                                if (horses == 0) {
                                    System.out.println(" Player " + (k + 1) + " has the Horses= 0");
                                } else {
                                    System.out.println(" Player " + (k + 1) + " has the Horses ");
                                    for (int i = 0; i < gameplayers[k].total_horse; i++) {
                                        System.out.println(" Horse" + (i + 1) + " = ( 'Name='"
                                                ...
                                                + gameplayers[k].horses[i].get_price()+"SEK  Age="
                                                + gameplayers[k].horses[i].get_Age()+"Months");
                                    }
                                }
                                if (cows == 0) {
                                    System.out.println(" Player " + (k + 1) + " has the Cows= 0");
                                } else {
                                    System.out.println(" Player " + (k + 1) + " has the Cows ");
                                    for (int i = 0; i < gameplayers[k].total_cow; i++) {
                                        System.out.println(" Cows" + (i + 1) + " = ( 'Name='"
                                                ...
                                                + gameplayers[k].cows[i].get_price()+"SEK  Age="
                                                + gameplayers[k].cows[i].get_Age()+"Months");
                                    }
                                }
                                if (buffalos == 0) {
                                    System.out.println(" Player " + (k + 1) + " has the Buffalos= 0");
                                } else {
                                    System.out.println(" Player " + (k + 1) + " has the Buffalos ");
                                    for (int i = 0; i < gameplayers[k].total_buffalo; i++) {
                                        System.out.println(" Buffalos" + (i + 1) + " = ( 'Name='"
                                                ...
                                                + gameplayers[k].buffaloes[i].get_price()+"SEK   Age="
                                                + gameplayers[k].buffaloes[i].get_Age());
                                    }
                                }
                                System.out.println(" Player " + (k + 1) + " has the Fruits= " + gameplayers[k].fruits.get_quantity() + "kg");
                                System.out.println(" Player " + (k + 1) + " has the Vegetables= " + gameplayers[k].vegetables.get_quantity() + "kg");
                                System.out.println(" Player " + (k + 1) + " has the CattleFeed= " + gameplayers[k].cattlefeeds.get_quantity() + "kg");
                            ...
                            while (true) //this loop is used to handle the game points
                            {
                                ...
                                if (choice == 1) //this condition is used to check that can player wants to buy the Animal?
                                {
                                    ...
                                    store.buyAnimal(gameplayers, k);
                                    break;
                                } else if (choice == 2) {
                                    Store store = new Store();
                                    store.buyFood(gameplayers, k);
                                    break;
                                } else if (choice == 3) {
                                    while (true) {
                                        int choice2;
                                                ...
                                                if (choice3 == 1) {
                                                    ...
                                                    if (cat == 0) {
                                                        ...
                                                        while (true) {
                                                            ...
                                                            choice4 = get.nextInt();
                                                            if (choice4 <= cat) {
                                                                int health = gameplayers[k].cats[choice4 - 1].get_health();
                                                                if (health != 0) {
                                                                    int feed_quantity;
                                                    ...
                                                    while (true) {
                                                        ...
                                                        if ((choice4 - 1) != k && choice4 <= players) {
                                                            ...
                                                            if (price <= (gameplayers[choice4 - 1].getMoney())) {
                                                                ...
                                                                System.out.println(" The cat is sold: You get Money= " + price + "SEK and this amount is added tp your account!");
                                                                break;
                                                            } else {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        if ((choice4 - 1) != k && choice4 <= players) {
                                                            ...
                                                            if (price <= (gameplayers[choice4 - 1].getMoney())) {
                                                                ...
                                                                System.out.println(" The Horse is sold: You get Money= " + price + "SEK and this amount is added tp your account!");
                                                                break;
                                                            } else {
                                                                System.out.println(" The Selected Player don't have enough Money! Thanks.");
                                                                break;
                                                    ...
                                                    if ((choice4 - 1) != k && choice4 <= players) {
                                                        if ((gameplayers[choice4 - 1].total_cat) == 0) {
                                                            ...
                                                            if (price <= (gameplayers[k].getMoney())) {
                                                                ...
                                                                System.out.println(" You Buy the Cat: You Pay Money= " + price + "SEK and this amount is deducted your account!");
                                                                break;
                                                            } else {
                                                    ...
                                                    if ((choice4 - 1) != k && choice4 <= players) {
                                                        if ((gameplayers[choice4 - 1].total_dog) == 0) {
                                                            ...
                                                            if (price <= (gameplayers[k].getMoney())) {
                                                                ...
                                                                System.out.println(" You Buy the Dog: You Pay Money= " + price + "SEK and this amount is deducted your account!");
                                                                break;
                                                            } else {
                                                                System.out.println(" You don't have enough Money! Thanks.");
                                                                break;
                                                    ...
                                                    if ((choice4 - 1) != k && choice4 <= players) {
                                                        if ((gameplayers[choice4 - 1].total_horse) == 0) {
                                                            ...
                                                            if (price <= (gameplayers[k].getMoney())) {
                                                                ...
                                                                System.out.println(" You Buy the Horse: You Pay Money= " + price + "SEK and this amount is deductedfrom your account!");
                                                                break;
                                                            } else {
                                                                System.out.println(" You don't have enough Money! Thanks.");
                                                                break;
                                                    ...
                                                    if ((choice4 - 1) != k && choice4 <= players) {
                                                        if ((gameplayers[choice4 - 1].total_cow) == 0) {
                                                            ...
                                                            if (price <= (gameplayers[k].getMoney())) {
                                                                ...
                                                                System.out.println(" You Buy the Cow: You Pay Money= " + price + "SEK and this amount is deducted from your account!");
                                                                break;
                                                            } else {
                                                                System.out.println(" You don't have enough Money! Thanks.");
                                                                break;
                                                    ...
                                                    if ((choice4 - 1) != k && choice4 <= players) {
                                                        if ((gameplayers[choice4 - 1].total_buffalo) == 0) {
                                                            ...
                                                            if (price <= (gameplayers[k].getMoney())) {
                                                                ...
                                                                System.out.println(" You Buy the Buffalo: You Pay Money= " + price + "SEK and this amount is deducted from your account!");
                                                                break;
                                                            } else {
                                                                System.out.println(" You don't have enough Money! Thanks.");
                                                                break;
                        ...
                        for (int i = 0; i < players; i++) {
                            if (gameplayers[i].total_cat == 0) {
                                ...
                                for (int k = 0; k < gameplayers[i].total_cat; k++) {
                                    ...
                                    gameplayers[i].cats[k].setAge((gameplayers[i].cats[k].get_Age()+1));
                                }
                            }
                            if (gameplayers[i].total_dog == 0) {
                                ...
                                for (int k = 0; k < gameplayers[i].total_dog; k++) {
                                    ...
                                    gameplayers[i].dogs[k].setAge((gameplayers[i].dogs[k].get_Age()+1));
                                }
                            }
                            if (gameplayers[i].total_horse == 0) {
                                ...
                                for (int k = 0; k < gameplayers[i].total_horse; k++) {
                                    ...
                                    gameplayers[i].horses[k].setAge((gameplayers[i].horses[k].get_Age()+1));
                                }
                            }
                            if (gameplayers[i].total_cow == 0) {
                                ...
                                for (int k = 0; k < gameplayers[i].total_cow; k++) {
                                    ...
                                    gameplayers[i].cows[k].setAge((gameplayers[i].cows[k].get_Age()+1));
                                }
                            }
                            if (gameplayers[i].total_buffalo == 0) {
                                ...
                                for (int k = 0; k < gameplayers[i].total_buffalo; k++) {
                                    ...
                                    gameplayers[i].buffaloes[k].setAge((gameplayers[i].buffaloes[k].get_Age()+1));
                                }
                            }
                        }
                        if (j == rounds) {
                            ...
                            for (int i = 0; i < players; i++) {
                                ...
                                for (int k = 0; k < (gameplayers[i].total_cat); k++) {
                                    total_amount_player = total_amount_player + ((gameplayers[i].cats[k].get_health() * gameplayers[k].cats[j].get_price()) / 100);
                                }
                                for (int k = 0; k < (gameplayers[i].total_dog); k++) {
